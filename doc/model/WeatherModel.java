...
public class WeatherModel {
    ...
    private List<ListDTO> list;//N天的天气信息
    ...
    public static class ListDTO {
        ...
        public String toString() {
            return "ListDTO{" + "day='" + day + '\'' + ", tmpMin='" + tmpMin + '\'' + ", tmpMax='" + tmpMax + '\'' + ", condCodeDay='" + condCodeDay + '\'' + ", condCodeNight='" + condCodeNight + '\'' + ", condTextDay='" + condTextDay + '\'' + ", condTextNight='" + condTextNight + '\'' + ", sunrise='" + sunrise + '\'' + ", sunset='" + sunset + '\'' + ", windSpeedDay='" + windSpeedDay + '\'' + ", windSpeedNight='" + windSpeedNight + '\'' + ", precip='" + precip + '\'' + ", uvIndex='" + uvIndex + '\'' + ", humidity='" + humidity + '\'' + ", vis='" + vis + '\'' + '}';
        }
    }

    @Override
    public String toString() {
        return "Weather2Response{" + "loc='" + loc + '\'' + ", list=" + list + '}';
    }
}
